...
namespace SahamLibs\Mongodb\Relations;
...
class BelongsToArray extends EloquentBelongsToMany
{
    /**
    ...
    protected function setWhere()
    {
        ...
        $this->query->whereIn($foreign, $this->parent->{$this->relatedPivotKey});
    ...
    public function attach($id, array $attributes = [], $touch = true)
    {
        if ($id instanceof Model) {
            ...
            // Attach the new parent id to the related model.
            $query->push($this->foreignPivotKey, $this->parent->getIdAttribute(), true);
        }
    ...
    public function match(array $models, Collection $results, $relation)
    {
        ...
        foreach ($models as $model) {
            ...
            $model->setRelation(
                $relation,
                $this->related->newCollection($dic)
            );
        }
